...
const formatNum = (num) => num.toLocaleString('en-US', { notation: 'compact' });
...
const main = async () => {
    ...
    makeChart(get('date'), [
        { data: get('infected'), name: 'Infected', color: '#F8B425' },
        { data: get('recoveries'), name: 'Recoveries', color: '#049DD9' },
        { data: get('deaths'), name: 'Deaths', color: '#EC4561' },
    ]);
};
